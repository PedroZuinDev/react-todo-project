...
export const HomeScreen = ()=>{
    ...
    const deleteItem = async (id: string)=>{
        ...
        const immutableTasks = tasks.filter(index => index.uniqueid !== id);
        return setTasks(immutableTasks);
    }
                ...
                <div className="px-6 py-4">
                    ...
                    <div className="flex justify-between">
                        ...
                        <div>
                            ...
                            <button onClick={()=>{deleteItem(index.uniqueid)}} type="button" className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
